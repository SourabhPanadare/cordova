...
function changePlayer() {
		...
		switch (text.innerText) {
			case "red":text.innerText = text.style.background = "blue";change1.style.color="black";change2.style.color="black";change3.style.color="red";change4.style.color="black";hide.style.display="block";$('#dice').trigger("click");$('.pawns-blue').addClass('pawnzindex');break;
			case "blue":text.innerText = text.style.background = "yellow"; change1.style.color="black";change2.style.color="red";change3.style.color="black";change4.style.color="black";hide.style.display="none";$('.pawns-yellow').addClass('pawnzindex');break;
			case "yellow":text.innerText = text.style.background = "green";change1.style.color="black";change2.style.color="black";change3.style.color="black";change4.style.color="red";hide.style.display="block";$('#dice').trigger("click");$('.pawns-green').addClass('pawnzindex');break;
			case "green":text.innerText = text.style.background = "red";change1.style.color="red";change2.style.color="black";change3.style.color="black";change4.style.color="black";hide.style.display="none";$('.pawns-red').addClass('pawnzindex'); break;
		}
    }
		...
		case "blue":
			for (var i = 1; i <=4; i++){
				if (onboard[text.innerText + "pawn" + i] == 1 ){
					...
					setTimeout(function(){randomMove("blue",paw);}, 5000);
					return;
				}
			}			
			break;
		...
		case "green":
			for (var i = 1; i <=4; i++){
				if (onboard[text.innerText + "pawn" + i] == 1 ){
					...
					setTimeout(function(){randomMove("green",paw);}, 5000);
					return;
				}
			}
			break;
