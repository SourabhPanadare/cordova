...
function changePlayer() {
   ...
   var text = document.getElementById('player');
		...
		switch (text.innerText) {
			case "red":text.innerText = text.style.background = "blue";change1.style.color="black";change2.style.color="red";change3.style.color="black";change4.style.color="black";hide.style.display="none";$('.pawns-blue').addClass('pawnzindex');break;
			case "blue":text.innerText = text.style.background = "yellow"; change1.style.color="black";change2.style.color="black";change3.style.color="red";change4.style.color="black";hide.style.display="none";$('.pawns-yellow').addClass('pawnzindex');break;
