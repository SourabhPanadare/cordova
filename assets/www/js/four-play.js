...
function changePlayer() {
		...
		switch (text.innerText) {
			case "red":text.innerText = text.style.background = "blue";change1.style.color="black";change2.style.color="red";change3.style.color="black";change4.style.color="black"; $('.pawns-blue').addClass('pawnzindex'); break;
			case "blue":text.innerText = text.style.background = "yellow"; change1.style.color="black";change2.style.color="black";change3.style.color="red";change4.style.color="black";$('.pawns-yellow').addClass('pawnzindex'); break;
			case "yellow":text.innerText = text.style.background = "green";change1.style.color="black";change2.style.color="black";change3.style.color="black";change4.style.color="red";$('.pawns-green').addClass('pawnzindex');break;
			case "green":text.innerText = text.style.background = "red";change1.style.color="red";change2.style.color="black";change3.style.color="black";change4.style.color="black";$('.pawns-red').addClass('pawnzindex'); break;
		}
        ...
        if (clicked) {
            ...
            if (text.innerText == currcolor) {
                if (onboard[currpawn] === 1 || num === 6) {
					...
					console.log("change player normal "+onboard[currpawn]);
                    CheckForWinner();    
					changePlayer();
